...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_7 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L generic_baseblocks_v2_1_1 -L axi_register_slice_v2_1_29 -L fifo_generator_v13_2_9 -L axi_data_fifo_v2_1_28 -L axi_crossbar_v2_1_30 -L gigantic_mux -L lib_pkg_v1_0_3 -L lib_fifo_v1_0_18 -L lib_srl_fifo_v1_0_3 -L axi_datamover_v5_1_31 -L axi_sg_v4_1_17 -L axi_dma_v7_1_30 -L axi_protocol_converter_v2_1_29 -L axi_clock_converter_v2_1_28 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot summer_design xil_defaultlib.summer_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim summer_design -key {Behavioral:sim_1:Functional:summer_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9d24.protoinst" -protoinst "protoinst_files/bd_5d75.protoinst" -protoinst "protoinst_files/bd_9db4.protoinst" -protoinst "protoinst_files/summer_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/vivado2023/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb summer_design.wdb xsim.dir libdpi.so)
